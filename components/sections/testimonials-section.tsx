      ...
      <Container>
        <Reveal>
          <SectionHeading
            ...
            title={
              <>
                Built to hold real client proof as Portfoo{" "}
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-start gap-4 rounded-3xl border border-sky/12 bg-sky/[0.03] p-5 max-w-3xl">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs leading-relaxed text-foreground/60">
                Portfoo is a newly launched digital partner. We choose not to showcase fake reviews or fabricate client numbers. The cards below are interactive previews ready for real client quotes. Want to be one of our first partners? Let&apos;s start a project today.
              </p>
            </div>
          </div>
        </Reveal>
